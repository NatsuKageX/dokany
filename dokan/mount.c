...
#define DOKAN_SYS_PATH                                                         \
  L"\\??\\C:\\Program Files (x86)\\ctyun\\dokan\\dokanPrivate" DOKAN_MAJOR_API_VERSION L".sys"
...
#define DOKAN_NP_SERVICE_KEY                                                   \
  L"System\\CurrentControlSet\\Services\\dokanPrivate" DOKAN_MAJOR_API_VERSION
#define DOKAN_NP_DEVICE_NAME                                                   \
  L"\\Device\\DokanRedirectorPrivate" DOKAN_MAJOR_API_VERSION
#define DOKAN_NP_NAME L"DokanPrivate" DOKAN_MAJOR_API_VERSION
